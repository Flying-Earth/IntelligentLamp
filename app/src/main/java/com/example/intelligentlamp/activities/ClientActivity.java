...
public class ClientActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String BLUETOOTH_NAME2 = "HC05_SLAVE";
...
//                    Toast.makeText(getApplicationContext(), "发送成功" + str, Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        mBtnBack = (Button)findViewById(R.id.client_back);
    ...
    public void onClick(View arg0) {
        switch(arg0.getId()){
            ...
            case R.id.btn_sendmessage:
                ...
                break;
            case R.id.client_back:
                Intent intent = new Intent(ClientActivity.this, BluetoothActivity.class);
