package com.example.intelligentlamp.views;
...
public class SeekBarColorPicker extends View {
    ...
    private void moved(float x, float y, boolean up) {
        ...
        if (distance < outerRadius + 100 && distance > innerRadius - 100 && !up) {
            ...
            if (mSeekBarColorPickerChangeListener != null) {
                ...
                mSeekBarColorPickerChangeListener.onProgressChange(this, paintInnerColor.getColor(), "#" + toHexString.substring(2, toHexString.length()),Color.red(paintInnerColor.getColor()),Color.green(paintInnerColor.getColor()),Color.blue(paintInnerColor.getColor()),angle);
            }
            invalidate();
        }
    ...
    public interface SeekBarColorPickerChangeListener {
        void onProgressChange(SeekBarColorPicker seekBarColorPicker, int color, String htmlColor,int R,int G,int c,int r);
    }
